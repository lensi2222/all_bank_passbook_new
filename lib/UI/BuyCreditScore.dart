...
class BuyCreditScore extends StatefulWidget {
  const BuyCreditScore({Key? key}) : super(key: key);

  @override
  State<BuyCreditScore> createState() => _BuyCreditScoreState();
}

class _BuyCreditScoreState extends State<BuyCreditScore> {
  @override
      ...
      body: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              Clipboard.setData(
                  ClipboardData(text: creditScoreDetailList[1].subtitle!))
                  .then((_) {
