...
class PersonalLoanScreen extends StatefulWidget {
  const PersonalLoanScreen({Key? key}) : super(key: key);
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        personalLoanList[index].interestRate!,
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                                          fontSize: 12.sp,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        personalLoanList[index].processingFee!,
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                                          fontSize: 12.sp,
                                          fontWeight: FontWeight.w500,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        personalLoanList[index].loanAmount!,
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                                          fontSize: 12.sp,
                                          fontWeight: FontWeight.w500,
