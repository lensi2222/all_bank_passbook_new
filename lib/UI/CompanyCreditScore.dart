...
class CompamyCreditScore extends StatefulWidget {
  const CompamyCreditScore({Key? key}) : super(key: key);

  @override
  State<CompamyCreditScore> createState() => _CompamyCreditScoreState();
}

class _CompamyCreditScoreState extends State<CompamyCreditScore> {
  @override
      ...
      body: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              Clipboard.setData(
                  ClipboardData(text: creditScoreDetailList[2].subtitle!))
                  .then((_) {
