...
class MissedCallBankBalance extends StatefulWidget {
  String? bankName;
  List<BankNumberDetail>? bankNumberData;

  MissedCallBankBalance({Key? key, this.bankNumberData, this.bankName})
      : super(key: key);

  @override
  State<MissedCallBankBalance> createState() => _MissedCallBankBalanceState();
}

class _MissedCallBankBalanceState extends State<MissedCallBankBalance> {
  @override
