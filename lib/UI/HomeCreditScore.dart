...
class HomeCreditScore extends StatefulWidget {
  const HomeCreditScore({Key? key}) : super(key: key);

  @override
  State<HomeCreditScore> createState() => _HomeCreditScoreState();
}

class _HomeCreditScoreState extends State<HomeCreditScore> {
  @override
      ...
      body: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              Clipboard.setData(
                      ClipboardData(text: creditScoreDetailList[0].subtitle!))
                  .then((_) {
